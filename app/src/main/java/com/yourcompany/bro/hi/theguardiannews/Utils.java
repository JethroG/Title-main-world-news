...
public class Utils {
    ...
    static List<ArtikleData> parseJson(String response) {
        ArrayList<ArtikleData> listOfNews = new ArrayList<>();
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                listOfNews.add(new ArtikleData(webTitle, author, url, date, section));
            }
